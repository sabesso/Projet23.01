...
player2WinsImg.src = "img2/P2Win.png";
let player1WinsImg = new Image; 
player1WinsImg.src = "img2/P1WIN.png";
let tieGame = new Image;
tieGame.src= "img2/DRAW.png"
...
function loadGame() { 
    ...
    class Player{           
            ...
            if (this.repeat < 6 && this.movement) { //  S
                ...
                if (this.frame == 2 ) { // if the player has been arrived to the place exact of array, we set
                    ...
                    if (this.repeat == 6) {
                        ...
                        if (this.nextDierection == up) {this.y -= speed}
                        else if (this.nextDierection  == down) {this.y += speed}
                        else if (this.nextDierection  == left) {this.x -= speed}
                        else if (this.nextDierection  == right) {this.x += speed};
                        endGameCheck = false;
                    }
                }
            } else {
        ...
        endGame(){               // killing player method
             if (endGameCheck) {        
                if([6,"E2","E3","E4","E5","E6"].includes(arrayBoard[player1.y/SQUARE_LENGTH][player1.x/SQUARE_LENGTH]) && this.bonusLife==false && varEndGame==false) { // check if the player 1 position contains any explosion                         
                ...
                if ([6,"E2","E3","E4","E5","E6"].includes(arrayBoard[player2.y/SQUARE_LENGTH][player2.x/SQUARE_LENGTH]) && this.bonusLife==false && varEndGame==false)   {// check if the player 2 position contains any explosion
        ...
        ifSuddenDeath(array,score){         
            if (endGameCheck) {
                if(checkSuddenDeath==false && arrayBoard[this.y/SQUARE_LENGTH][this.x/SQUARE_LENGTH]=="T" ){
                   
                    let imgTriforce= document.createElement("img"); 
                    imgTriforce.id= "imgTRIFORCE";
                    imgTriforce.src = "img2/triforce1.png" 
                ...
                if(this.bombRadius>=1){     
                    ...
                    let indexRandom = Math.floor(Math.random()*4);
                        ...
                        break // breaks the loop after the bombRadius encounters a non-breakable wall
                            ...
                            if(arrayBoard[this.bombY][this.bombX-i]==14 || arrayBoard[this.bombY][this.bombX-i]==15 || arrayBoard[this.bombY][this.bombX-i]=="M" ||arrayBoard[this.bombY][this.bombX-i]=="C" ) {  // check if the square contains a bonus
                ...
                if(this.bombRadius>=1){
                    ...
                    for ( let i=1; i<=this.bombRadius; i++) {
                        ...
                        if(arrayBoard[this.bombY][this.bombX+i]==18){  
                            ...
                            if(arrayBoard[this.bombY][this.bombX+i]==14 || arrayBoard[this.bombY][this.bombX+i]==15 || arrayBoard[this.bombY][this.bombX+i]=="M"|| arrayBoard[this.bombY][this.bombX+i]=="C"){
                                arrayBoard[this.bombY][this.bombX+i]=0;
                                break
                            }
                            else {
                ...
                if(this.bombRadius>=1){
                    for ( let i=1; i<=this.bombRadius; i++) {
                        ...
                        if(this.bombY+i <= LINE -1 && arrayBoard[this.bombY+i][this.bombX]==18){  
                            ...
                            if(arrayBoard[this.bombY+i][this.bombX] ==14  || arrayBoard[this.bombY+i][this.bombX]==15 || arrayBoard[this.bombY+i][this.bombX]=="M" || arrayBoard[this.bombY+i][this.bombX]=="C"){
                                arrayBoard[this.bombY+i][this.bombX] = 0;
                                break
                            }
                            else {
    ...
    function drawGame() {                           // global funtion to draw everything, the board, players, walls, animations( method cooldown)
        ...
        for (let i=numberBomb.length-1  ; i>=0 ; i--) {
            ...
            numberBomb[i].cooldown();             // each bomb in the array numberBomb calls the method cooldown(references the timer, and all animations)      
        }   
...
function drawStartGame(){    
    ...
    woodBtn.src = "img2/woodbtn.png";  
    let howtoImg = new Image; 
    howtoImg.src = "img2/binds.png";
